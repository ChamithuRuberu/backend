              ...
              <div className="row mb-2">
                ...
                <div className="col-sm-6">
                  <ol className="breadcrumb float-sm-right">
                    <li className="breadcrumb-item"><a href="src/component/Dashboard#">Home</a></li>
              ...
              <div className="row">
                <div className="col-lg-3 col-6">
                  ...
                  <div className="small-box bg-info">
                    ...
                    <a href="src/component/Dashboard#" className="small-box-footer">More info <i className="fas fa-arrow-circle-right" /></a>
                  </div>
                </div>
                {/* ./col */}
                <div className="col-lg-3 col-6">
                ...
                <section className="col-lg-7 connectedSortable">
                      ...
                      <div className="card-tools">
                        <ul className="nav nav-pills ml-auto">
                          <li className="nav-item">
                            <a className="nav-link active" href="src/component/Dashboard#revenue-chart" data-toggle="tab">Area</a>
                          </li>
                          <li className="nav-item">
                            <a className="nav-link" href="src/component/Dashboard#sales-chart" data-toggle="tab">Donut</a>
                          </li>
                        </ul>
                      </div>
                    </div>{/* /.card-header */}
                  ...
                  <div className="card direct-chat direct-chat-primary">
                    ...
                    <div className="card-body">
                      ...
                      <div className="direct-chat-contacts">
                        <ul className="contacts-list">
                          <li>
                            <a href="src/component/Dashboard#">
                    ...
                    <div className="card-footer">
                      <form action="src/component/Dashboard#" method="post">
                    ...
                    <div className="card-header">
                      ...
                      <div className="card-tools">
                        <ul className="pagination pagination-sm">
                          <li className="page-item"><a href="src/component/Dashboard#" className="page-link">«</a></li>
                          <li className="page-item"><a href="src/component/Dashboard#" className="page-link">1</a></li>
                          <li className="page-item"><a href="src/component/Dashboard#" className="page-link">2</a></li>
                          <li className="page-item"><a href="src/component/Dashboard#" className="page-link">3</a></li>
                          <li className="page-item"><a href="src/component/Dashboard#" className="page-link">»</a></li>
                        </ul>
                      </div>
                    </div>
                      ...
                      <div className="card-tools">
                        ...
                        <div className="btn-group">
                          ...
                          <div className="dropdown-menu float-right" role="menu">
                            <a href="src/component/Dashboard#" className="dropdown-item">Add new event</a>
                            <a href="src/component/Dashboard#" className="dropdown-item">Clear events</a>
                            <div className="dropdown-divider" />
                            <a href="src/component/Dashboard#" className="dropdown-item">View calendar</a>
                          </div>
                        </div>
